...
export default function ProcessingOrdersPage() {
  ...
  const loadOrders = async () => {
    try {
      const res = await fetch(`${API}/api/orders?fulfillmentStatus=packed`, {
        cache: "no-store",
      });
      ...
      console.log("Processing Orders Fetch Error:", err);
      setLoading(false);
    }
  };
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Orders currently being prepared, QC-ed or packed.
            </p>
          </div>
              ...
              {filteredOrders.length > 0 ? (
                filteredOrders.map((order) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 capitalize text-purple-600 font-semibold">
