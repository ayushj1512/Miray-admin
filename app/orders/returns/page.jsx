...
export default function ReturnedOrdersPage() {
  ...
  const loadOrders = async () => {
    try {
      ...
      console.log("Returned Orders Fetch Error:", err);
      setLoading(false);
    }
  };
    ...
    <section className="min-h-screen bg-gray-50 p-10">
      <div className="max-w-7xl mx-auto space-y-10">
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold">Returned & Cancelled Orders</h1>
            <p className="text-gray-500 mt-1">
              Orders marked as returned or cancelled.
            </p>
          </div>
              ...
              {filteredOrders.length > 0 ? (
                filteredOrders.map((order) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 capitalize text-red-600 font-semibold">
