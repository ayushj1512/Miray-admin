...
export default function ShippedOrdersPage() {
  ...
  const loadOrders = async () => {
    try {
      const res = await fetch(`${API}/api/orders?fulfillmentStatus=shipped`, {
        cache: "no-store",
      });
      ...
      console.log("Shipped Orders Fetch Error:", err);
      setLoading(false);
    }
  };
        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Orders dispatched from warehouse and currently in transit.
            </p>
          </div>
