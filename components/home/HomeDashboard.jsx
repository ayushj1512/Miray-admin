...
const DOMAIN_LIST = [
  ...
  {
  id: "tailor_production_jobs",
  name: "Tailor Production Jobs",
  icon: ClipboardPlus,
  route: "/tailor-production-jobs",
},
];
